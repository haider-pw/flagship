...
$reservations = mysql_query("SELECT * FROM skb_reservations WHERE arr_driver > 0 AND status = 1"); 
                                    ...
                                    <table id="res-arrivals" class="table table-hover datatable display">
                                        ...
                                        <?php
                                            while($row = mysql_fetch_array($reservations)) {
                                                ...
                                                $dpt_time = mysql_fetch_row(mysql_query("SELECT * FROM skb_flighttime WHERE id_fltime='" . $row[27] . "'"));                                                     
