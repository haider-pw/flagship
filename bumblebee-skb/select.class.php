...
class SelectList
{
    protected $connd;
        ...
        {
            $sql = "SELECT * FROM skb_transport ORDER BY name ASC";
        ...
        {
            $sql = "SELECT * FROM skb_flights ORDER BY flight_number ASC";
        ...
        {
            $sql = "SELECT * FROM skb_flighttime WHERE id_flight=$_POST[flightid] ORDER BY flight_time ASC";
        ...
        {
            $sql = "SELECT * FROM skb_roomtypes WHERE id_location=$_POST[locationid] ORDER BY room_type ASC";
