...
$ftrows = mysql_query("SELECT ftnotify FROM skb_reservations WHERE ftnotify = 1 AND status = 1");
if($ftrows){
...
?>
<li class="xn-title">Navigation - SKB <span class="flag-icon flag-icon-kn"></span></li>
<li class="active">
