...
/**
 * $reservations = mysql_fetch_row(mysql_query("SELECT * FROM skb_reservations WHERE id='" . $reservation_id . "'"));
...
/**
 * $guest_check = mysql_fetch_row(mysql_query("SELECT * FROM skb_guest WHERE id='" . $reservation_id . "'"));
...
$sql=mysql_query("delete from skb_guest where id='$guest_id'");
