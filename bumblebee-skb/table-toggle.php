...
$log = mysql_query("SELECT * FROM skb_activity");
?>
<script type="text/javascript">
    ...
    $('a.toggle-vis').on( 'click', function (e) {
        ...
        </script>            <?php include ('profile.php'); ?>
                ...
                <div class="page-content-wrap">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div>
					           Toggle column: <a class="toggle-vis" data-column="0">Time</a> - <a class="toggle-vis" data-column="1">User</a> - <a class="toggle-vis" data-column="2">Action</a>
				            </div>                            
