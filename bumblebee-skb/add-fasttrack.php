...
//Sanitize data
    ...
    if ($arr_driver > 0){
        $res_type_arr = 1;
        $sql5 = "INSERT INTO skb_resdrivers ". 
    ...
    if ($dpt_driver > 0){
        $res_type_dpt = 2;
        $sql6 = "INSERT INTO skb_resdrivers ". 
        "(transport, vehicle, ref_no_sys, adult, child, infant, tour_operator, location, pickup_time,  comments, flight_time, flight_no, infant_seats, child_seats, booster_seats, title_name, first_name, last_name, transport_date, res_type) ". 
                                ...
                                <div class="panel-body">                                                                        
                                    <div class="form-group">                                         
                                        <div class="form-inline col-xs-7"><!-- first name / last name fields -->
                                            <input type="text" class="form-control left20" placeholder="Last name" id="last-name" name="last_name" value="" required>
                                            <input type="text" class="form-control left20" placeholder="First name" id="first-name" name="first_name" value="" required>
                                    ...
                                    <div class="form-group col-xs-7"><!-- affiliates field -->
                                        <input type="text" class="form-control" placeholder="Affiliates" id="affiliates" name="affiliates" value="">
                                    </div>
                                    <div class="form-group">                                         
                                ...
                                <div class="clientreqs reqs-box">
                                    ...
                                    <div class="form-group">                                         
                                            <div class="form-inline col-xs-9">
                                                ...
                                                <input type="number" min=0 max=99 class="right20 form-control" id="vouchers" name="vouchers" value="" placeholder="Vouchers">
                                            </div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
