...
$reservation = mysql_fetch_row(mysql_query("SELECT * FROM anu_reservations WHERE id='" . QuoteSmart($_GET['id']) . "'"));
$get_rep = mysql_fetch_row(mysql_query("SELECT * FROM anu_reps WHERE id_rep='" . $reservation[42] . "'"));
$repselect = mysql_query("SELECT * FROM anu_reps ORDER BY name ASC");
...
//Sanitize data
    ...
    $rep_action = mysql_fetch_row(mysql_query("SELECT * FROM anu_reps WHERE id_rep='" . $rep_name . "'"));
