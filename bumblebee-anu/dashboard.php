...
$res = mysql_query("SELECT * FROM anu_reservations WHERE arr_date >= DATE(NOW()) AND status = 1");
...
$transport = mysql_query("SELECT * FROM anu_resdrivers WHERE transport_date >= DATE(NOW())");
