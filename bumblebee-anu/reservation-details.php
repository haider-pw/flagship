...
$transport_arr = mysql_query("SELECT * FROM anu_resdrivers WHERE ref_no_sys='$flagship_ref' AND res_type=1");
$arr_count = mysql_numrows($transport_arr);

$transport_dpt = mysql_query("SELECT * FROM anu_resdrivers WHERE ref_no_sys='$flagship_ref' AND res_type=2");
