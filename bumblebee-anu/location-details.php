...
$location = mysql_fetch_row(mysql_query("SELECT * FROM anu_location WHERE id_location='" . QuoteSmart($_GET['id']) . "'"));
$location_id = $_GET['id'];

$room_types = mysql_query("SELECT * FROM anu_roomtypes WHERE id_location = $location_id");
