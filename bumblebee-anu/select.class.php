...
class SelectList
{
    protected $connd;
        ...
        {
            $sql = "SELECT * FROM anu_transport ORDER BY name ASC";
        ...
        {
            $sql = "SELECT * FROM anu_vehicles WHERE id_transport=$_POST[driverid] ORDER BY name ASC";
            $resd= mysql_query($sql,$this->connd);
        ...
        {
            $sql = "SELECT * FROM anu_flights ORDER BY flight_number ASC";
        ...
        {
            $sql = "SELECT * FROM anu_flighttime WHERE id_flight=$_POST[flightid] ORDER BY flight_time ASC";
        ...
        {
            $sql = "SELECT * FROM anu_location ORDER BY name ASC";
            $flightd= mysql_query($sql,$this->connd);
        ...
        {
            $sql = "SELECT * FROM anu_roomtypes WHERE id_location=$_POST[locationid] ORDER BY room_type ASC";
