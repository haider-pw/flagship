...
$reservations = mysql_query("SELECT * FROM anu_reservations WHERE status = 1");
                                    ...
                                    <table id="res-arrivals" class="table table-hover datatable display">
                                        ...
                                        <?php
                                            ...
                                            while($row = mysql_fetch_array($reservations)) {
                                                ...
                                                $room_type = mysql_fetch_row(mysql_query("SELECT * FROM anu_roomtypes WHERE id_room='" . $row[23] . "'"));
                                                $guest = mysql_query("SELECT * FROM anu_guest WHERE ref_no_sys='" . $row[40] . "'");
                                                ...
                                                $hotel = mysql_fetch_row(mysql_query("SELECT * FROM anu_location WHERE id_location='" . $row[22] . "'"));
