        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-sm btn-success add" data-toggle="modal" data-target="#edit-tour">Add New Supplier</a>
              <h3 class="box-title pull-right">Total Suppliers: <span class="tour-count"><?=count($operators)?></span></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             <?php 
                $data['operators']=$operators;
                $this->load->view('fasttrack/op_list', $data); 
                ?>
            </div>
            <!-- /.box-body -->
          </div>
