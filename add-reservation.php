...
//Sanitize data
    ...
    $transfer_time           = QuoteSmart($_POST['transfer_time']);
    ...
    $transfer_time1           = QuoteSmart($_POST['transfer_time1']);
    ...
    $transfer_time2           = QuoteSmart($_POST['transfer_time2']);
    ...
    $transfer_time3           = QuoteSmart($_POST['transfer_time3']);
    ...
    for($i=0; $i < count($_POST["guest_title_name"]); $i++) {
        if ($i>=1){
            ...
            $guest_adult = QuoteSmart($_POST['guest_adult'][$i]);
    ...
    $sql_2 = "INSERT INTO bgi_arrivals ". 
    ...
    if($_POST['arrival3active'] == 1){
    $sql_9 = "INSERT INTO bgi_arrivals ". 
        "(ref_no_sys, arr_date, arr_time, arr_flight_no, flight_class, arr_transport, arr_driver, arr_vehicle, arr_pickup, arr_dropoff, room_type, rep_type, client_reqs, arr_transport_notes, arr_hotel_notes, infant_seats, child_seats, booster_seats, vouchers, cold_towel, bottled_water, rooms, room_no) ". 
    ...
    $sql_3 = "INSERT INTO bgi_departures ". 
        ...
        "VALUES ('$fsref', '$dpt_date', '$dpt_time', '$dpt_flight_no', '$dpt_flight_class', '$dpt_transport', '$dpt_driver', '$dpt_vehicle_no', '$dpt_pickup', '$dpt_dropoff', '$pickup_time', '$dpt_transport_notes')";
        $retval3 = mysql_query( $sql_3, $conn );
    
    if($_POST['departure1active'] == 1){
    ...
    if(is_numeric($transfer_pickup)){
    $sql_13 = "INSERT INTO bgi_transfer ". 
        "(ref_no_sys, pickup, pickup_date, pickup_time, dropoff, transport, vehicle, driver, transfer_notes) ". 
        "VALUES ('$fsref', '$transfer_pickup','$transfer_pickup_date', '$transfer_pickup_time', '$transfer_dropoff', '$transfer_transport', '$transfer_vehicle', '$transfer_driver', '$transfer_notes')";
        $retval13 = mysql_query( $sql_13, $conn );
    }
    
    if($_POST['transfer1active'] == 1){
    $sql_14 = "INSERT INTO bgi_transfer ". 
        "(ref_no_sys, pickup, pickup_date, pickup_time, dropoff, transport, vehicle, driver, transfer_notes) ". 
        "VALUES ('$fsref', '$transfer_pickup1','$transfer_pickup_date1', '$transfer_pickup_time1', '$transfer_dropoff1', '$transfer1_transport', '$transfer_vehicle1', '$transfer_driver1', '$transfer_notes1')";
        $retval14 = mysql_query( $sql_14, $conn );
    }
    
    if($_POST['transfer2active'] == 1){
    $sql_15 = "INSERT INTO bgi_transfer ". 
        "(ref_no_sys, pickup, pickup_date, pickup_time, dropoff, transport, vehicle, driver, transfer_notes) ". 
        "VALUES ('$fsref', '$transfer_pickup2','$transfer_pickup_date2', '$transfer_pickup_time2', '$transfer_dropoff2', '$transfer2_transport', '$transfer_vehicle2', '$transfer_driver2', '$transfer_notes2')";
        $retval15 = mysql_query( $sql_15, $conn );
    }
    
    if($_POST['transfer3active'] == 1){
    $sql_16 = "INSERT INTO bgi_transfer ". 
        "(ref_no_sys, pickup, pickup_date, pickup_time, dropoff, transport, vehicle, driver, transfer_notes) ". 
        "VALUES ('$fsref', '$transfer_pickup3','$transfer_pickup_date3', '$transfer_pickup_time3', '$transfer_dropoff3', '$transfer3_transport', '$transfer_vehicle3', '$transfer_driver3', '$transfer_notes3')";
        $retval16 = mysql_query( $sql_16, $conn );
    }        
    //Post driver info to jobsheet
    if ($arr_driver > 0){
        $res_type_arr = 1;
        $sql5 = "INSERT INTO bgi_resdrivers ". 
    ...
    if ($dpt_driver > 0){
        $res_type_dpt = 2;
        $sql6 = "INSERT INTO bgi_resdrivers ". 
        "(transport, vehicle, ref_no_sys, adult, child, infant, tour_operator, location, pickup_time,  comments, flight_time, flight_no, infant_seats, child_seats, booster_seats, title_name, first_name, last_name, transport_date, res_type) ". 
            ...
            $('input[type="checkbox"]').click(function(){
                ...
                <script>
                    $(function(){
                        ...
                        $('a.addguest').relCopy({limit: 0, append: removeLink, clearInputs: true});
                    });
                </script>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">                                                                        
                                    <div class="form-group">                                         
                                        <div class="form-inline col-xs-8"><!-- first name / last name fields -->
                                            <label class="left20">First name</label> <input type="text" class="form-control right20" placeholder="First name" id="first-name" name="first_name" value="" required>
                                            <label>Last name</label> <input type="text" class="form-control" placeholder="Last name" id="last-name" name="last_name" value="" required>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-7">                                            
                                            ...
                                            <textarea class="form-control" rows="5" id="tour-notes" name="tour_notes" placeholder="Rep notes: additional rep comments and details here"></textarea>
                                        </div>
                                    </div>
                                    <hr />
                                <!-- guests -->
                                ...
                                <div class="guest" style="margin-bottom: 15px;">
                                    <div class="form-group">                                         
                                        ...
                                        <label>Title</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Valid Titles: Mr | Mrs | Ms | Miss | Master | Dr | Sir | Lord | Lady"></i> <input type="text" class="form-control" placeholder="Title" id="guest-title-name" name="guest_title_name[]" value="">
                                            <label class="left20">First name</label> <input type="text" class="form-control right20" placeholder="First name" id="guest-first-name" name="guest_first_name[]" value="">
                                            <label>Last name</label> <input type="text" class="form-control right20" placeholder="Last name" id="guest-last-name" name="guest_last_name[]" value="">
                                    ...
                                    <div class="form-group">                                         
                                        <div class="form-inline col-xs-8"><!-- guest first name / guest last name fields -->
                                            <label>Adult</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Enter 1 if this is an adult otherwise leave blank"></i> <input type="text" class="form-control right20" placeholder="Enter (1) if this is an adult" id="guest-adult" name="guest_adult[]" value="">
                                ...
                                <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">                                            
                                        ...
                                        <textarea class="form-control" rows="5" id="arr-transport-notes" name="arr_transport_notes" placeholder="Arrival &amp; Transportation notes: additional arrival &amp; transport comments and details here"></textarea>
                                    </div>
                                 </div>
                                ...
                                <div class="form-group col-xs-2"><!-- number of rooms -->
                                 ...
                                 <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">                                            
                                        ...
                                        <textarea class="form-control" rows="5" id="arr-hotel-notes" name="arr_hotel_notes" placeholder="Hotel notes: additional hotel comments and details here"></textarea>
                                    </div>
                                 </div>
                                ...
                                <!-- arrival 1 -->
                                <div id="arrival1show">
                                <input type="hidden" id="arrival1active" value="0" />
                                <hr />
                                <h4>Arrival Details</h4>
                                <div class="form-group">
                                    <div class="form-inline left20">
                                ...
                                <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">                                            
                                        <label>Arrival &amp; Transport notes</label>
                                        <textarea class="form-control" rows="5" id="arr-transport-notes1" name="arr_transport_notes1" placeholder="Arrival &amp; Transportation notes: additional arrival &amp; transport comments and details here"></textarea>
                                    </div>
                                 </div>
                                <div class="form-group col-xs-7"><!-- pickup location selection -->
                                    <label>Pickup Location</label>
                                ...
                                <div class="form-group col-xs-2"><!-- number of rooms -->
                                 ...
                                 <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">                                            
                                        <label>Hotel notes</label>
                                        <textarea class="form-control" rows="5" id="arr-hotel-notes1" name="arr_hotel_notes1" placeholder="Hotel notes: additional hotel comments and details here"></textarea>
                                    </div>
                                 </div>
                                <div class="form-group col-xs-7"><!-- representation type selection -->
                                    <label>Represetation Type</label>
                                ...
                                <!-- arrival 2 -->
                                <div id="arrival2show">
                                <input type="hidden" id="arrival2active" value="0" />
                                <hr />
                                <h4>Arrival Details</h4>
                                <div class="form-group">
                                    <div class="form-inline left20">
                                ...
                                <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">                                            
                                        <label>Arrival &amp; Transport notes</label>
                                        <textarea class="form-control" rows="5" id="arr-transport-notes2" name="arr_transport_notes2" placeholder="Arrival &amp; Transportation notes: additional arrival &amp; transport comments and details here"></textarea>
                                    </div>
                                 </div>
                                <div class="form-group col-xs-7"><!-- pickup location selection -->
                                    <label>Pickup Location</label>
                                ...
                                <div class="form-group col-xs-2"><!-- number of rooms -->
                                 ...
                                 <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">                                            
                                        <label>Hotel notes</label>
                                        <textarea class="form-control" rows="5" id="arr-hotel-notes2" name="arr_hotel_notes2" placeholder="Hotel notes: additional hotel comments and details here"></textarea>
                                    </div>
                                 </div>
                                <div class="form-group col-xs-7"><!-- representation type selection -->
                                    <label>Represetation Type</label>
                                ...
                                <!-- arrival 3 -->
                                <div id="arrival3show">
                                <input type="hidden" id="arrival3active" value="0" />
                                <hr />
                                <h4>Arrival Details</h4>
                                <div class="form-group">
                                    <div class="form-inline left20">
                                ...
                                <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">                                            
                                        <label>Arrival &amp; Transport notes</label>
                                        <textarea class="form-control" rows="5" id="arr-transport-notes3" name="arr_transport_notes3" placeholder="Arrival &amp; Transportation notes: additional arrival &amp; transport comments and details here"></textarea>
                                    </div>
                                 </div>
                                <div class="form-group col-xs-7"><!-- pickup location selection -->
                                    <label>Pickup Location</label>
                                ...
                                <div class="form-group col-xs-2"><!-- number of rooms -->
                                 ...
                                 <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">                                            
                                        <label>Hotel notes</label>
                                        <textarea class="form-control" rows="5" id="arr-hotel-notes3" name="arr_hotel_notes3" placeholder="Hotel notes: additional hotel comments and details here"></textarea>
                                    </div>
                                 </div>
                                <div class="form-group col-xs-7"><!-- representation type selection -->
                                    <label>Represetation Type</label>
                                ...
                                <div class="clearfix"></div>
                                 <div class="form-group col-xs-7"><!-- dropoff location selection -->
                                    <label>Dropoff Location</label>
                                    <select class="form-control" id="transfer-dropoff" name="transfer-dropoff">
                                        <?php echo $opt->ShowLocation(); ?>     
                                    </select>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="form-group col-xs-3"><!-- vehicle # selection -->
                                  ...
                                  <div><button id="transfer1" class="btn btn-warning">Add Transfer</button></div>
                                </div>
                                <div class="clearfix"></div>
                                <!-- end transfer main -->
                                ...
                                <input type="hidden" id="transfer1active" value="0" />
                                <hr />
                                <h4>Inter-Hotel Transfer Details</h4>
                                <div class="form-group col-xs-4 right20"><!-- pickup location selection -->
                                    <label>Pickup Location</label>
                                ...
                                <div class="clearfix"></div>
                                 <div class="form-group col-xs-7"><!-- dropoff location selection -->
                                    <label>Dropoff Location</label>
                                    <select class="form-control" id="transfer-dropoff1" name="transfer-dropoff1">
                                        <?php echo $opt->ShowLocation(); ?>     
                                    </select>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="form-group col-xs-3"><!-- vehicle # selection -->
                                  ...
                                  <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">                                            
                                        <label>Transfer &amp; Transport notes</label>
                                        <textarea class="form-control" rows="5" id="transfer-notes1" name="transfer_notes1" placeholder="Transfer &amp; Transportation notes: additional transfer &amp; transport comments and details here"></textarea>
                                    </div>
                                 </div>
                                ...
                                <input type="hidden" id="transfer2active" value="0" />
                                <hr />
                                <h4>Inter-Hotel Transfer Details</h4>
                                <div class="form-group col-xs-4 right20"><!-- pickup location selection -->
                                    <label>Pickup Location</label>
                                ...
                                <div class="clearfix"></div>
                                 <div class="form-group col-xs-7"><!-- dropoff location selection -->
                                    <label>Dropoff Location</label>
                                    <select class="form-control" id="transfer-dropoff2" name="transfer-dropoff2">
                                        <?php echo $opt->ShowLocation(); ?>     
                                    </select>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="form-group col-xs-3"><!-- vehicle # selection -->
                                  ...
                                  <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">                                            
                                        <label>Transfer &amp; Transport notes</label>
                                        <textarea class="form-control" rows="5" id="transfer-notes2" name="transfer_notes2" placeholder="Transfer &amp; Transportation notes: additional transfer &amp; transport comments and details here"></textarea>
                                    </div>
                                 </div>
                                ...
                                <input type="hidden" id="transfer3active" value="0" />
                                <hr />
                                <h4>Inter-Hotel Transfer Details</h4>
                                <div class="form-group col-xs-4 right20"><!-- pickup location selection -->
                                    <label>Pickup Location</label>
                                ...
                                <div class="clearfix"></div>
                                 <div class="form-group col-xs-7"><!-- dropoff location selection -->
                                    <label>Dropoff Location</label>
                                    <select class="form-control" id="transfer-dropoff3" name="transfer-dropoff3">
                                        <?php echo $opt->ShowLocation(); ?>     
                                    </select>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="form-group col-xs-3"><!-- vehicle # selection -->
                                  ...
                                  <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">                                            
                                        <label>Transfer &amp; Transport notes</label>
                                        <textarea class="form-control" rows="5" id="transfer-notes3" name="transfer_notes3" placeholder="Transfer &amp; Transportation notes: additional transfer &amp; transport comments and details here"></textarea>
                                    </div>
                                 </div>
                                ...
                                <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">
                                        ...
                                        <textarea class="form-control" rows="5" id="dpt-transport-notes" name="dpt_transport_notes" placeholder="Departure &amp; Transportation notes: additional departure &amp; transport comments and details here"></textarea>
                                    </div>
                                 </div>
                                ...
                                <input type="hidden" id="departure1active" value="0" />
                                <hr />
                                <h4>Departure Details</h4>
                                <div class="form-group">
                                    <div class="form-inline left20">
                                ...
                                <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">
                                        <label>Departure &amp; Transport notes</label>                                            
                                        <textarea class="form-control" rows="5" id="dpt-transport-notes1" name="dpt_transport_notes1" placeholder="Departure &amp; Transportation notes: additional departure &amp; transport comments and details here"></textarea>
                                    </div>
                                 </div>
                                ...
                                <input type="hidden" id="departure2active" value="0" />
                                <hr />
                                <h4>Departure Details</h4>
                                <div class="form-group">
                                    <div class="form-inline left20">
                                ...
                                <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">
                                        <label>Departure &amp; Transport notes</label>                                            
                                        <textarea class="form-control" rows="5" id="dpt-transport-notes2" name="dpt_transport_notes2" placeholder="Departure &amp; Transportation notes: additional departure &amp; transport comments and details here"></textarea>
                                    </div>
                                 </div>
                                ...
                                <input type="hidden" id="departure3active" value="0" />
                                <hr />
                                <h4>Departure Details</h4>
                                <div class="form-group">
                                    <div class="form-inline left20">
                                ...
                                <div class="form-group"><!-- hotel notes -->
                                    <div class="col-xs-7">
                                        <label>Departure &amp; Transport notes</label>                                            
                                        <textarea class="form-control" rows="5" id="dpt-transport-notes3" name="dpt_transport_notes3" placeholder="Departure &amp; Transportation notes: additional departure &amp; transport comments and details here"></textarea>
                                    </div>
                                 </div>
                                ...
                                <div class="form-group"><!-- accounting notes -->
                                        <div class="col-xs-7">
                                            ...
                                            <textarea class="form-control" rows="5" id="dpt-notes" name="dpt_notes" placeholder="Accounting notes: additional accounting comments and details here"></textarea>
                                        </div>
                                    </div>
