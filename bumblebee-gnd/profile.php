...
consoleChat('<?php echo $loggedinas; ?>');// username not necessarily, default name Guest
                    ...
                    <li class="xn-profile">
                        <a href="#" class="profile-mini">
                            <img src="../admin-panel-gnd/thumbmaker.php?src=<?php echo UPLOADURL;?><?php echo ($row->avatar) ? $row->avatar : "blank.png";?>&amp;w=<?php echo $core->thumb_w;?>&amp;h=<?php echo $core->thumb_h;?>&amp;s=1&amp;a=t1" alt="<?php echo $loggedinas; ?>"/>
                        </a>
                        <div class="profile">
