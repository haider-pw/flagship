...
$ftrows = mysql_query("SELECT ftnotify FROM gnd_reservations WHERE ftnotify = 1 AND status = 1");
if($ftrows){
...
?>
<li class="xn-title">Navigation - GND <span class="flag-icon flag-icon-gd"></span></li>
<li class="active">
