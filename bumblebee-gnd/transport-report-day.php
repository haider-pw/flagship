...
$transport = mysql_query("SELECT * FROM gnd_resdrivers WHERE transport_date = DATE_SUB(NOW(), INTERVAL 1 DAY) ORDER BY transport_date");
?>
                                    ...
                                    <table id="transfer-queue" class="table table-hover datatable">
                                        ...
                                        <?php
                                            while($row = mysql_fetch_array($transport)) {
                                                ...
                                                $driver = mysql_fetch_row(mysql_query("SELECT * FROM gnd_transport WHERE id_transport='" . $row[1] . "'"));
                                                $tour_oper = mysql_fetch_row(mysql_query("SELECT * FROM gnd_touroperator WHERE id='" . $row[7] . "'"));
                                                $flight = mysql_fetch_row(mysql_query("SELECT * FROM gnd_flights WHERE id_flight='" . $row[13] . "'"));
                                                $pickup = mysql_fetch_row(mysql_query("SELECT * FROM gnd_flighttime WHERE id_fltime='" . $row[9] . "'"));
                                                $location = mysql_fetch_row(mysql_query("SELECT * FROM gnd_location WHERE id_location='" . $row[8] . "'"));
                                                $guest = mysql_query("SELECT * FROM gnd_guest WHERE ref_no_sys='" . $row[3] . "'");
