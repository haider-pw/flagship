...
$reservations = mysql_query("SELECT * FROM gnd_reservations WHERE status = 1 AND fast_track = 1 AND assigned = 1");
?>
                                    ...
                                    <table id="res-arrivals" class="table table-hover datatable">
                                        ...
                                        <?php
                                            while($row = mysql_fetch_array($reservations)) {
                                                ...
                                                $arr_dropoff = mysql_fetch_row(mysql_query("SELECT * FROM gnd_location WHERE id_location='" . $row[22] . "'"));
                                                $rep = mysql_fetch_row(mysql_query("SELECT * FROM gnd_reps WHERE id_rep='" . $row[42] . "'"));
