...
$transport = mysql_fetch_row(mysql_query("SELECT * FROM gnd_transport WHERE id_transport='" . QuoteSmart($_GET['id']) . "'"));
$transport_id = $_GET['id'];

$vehicles = mysql_query("SELECT * FROM gnd_vehicles WHERE id_transport = $transport_id");
