...
$reservations = mysql_query("SELECT * FROM gnd_reservations WHERE arr_driver > 0 AND status = 1"); 
                                    ...
                                    <table id="res-arrivals" class="table table-hover datatable display">
                                        ...
                                        <?php
                                            while($row = mysql_fetch_array($reservations)) {
                                                ...
                                                $arr_flight_no = mysql_fetch_row(mysql_query("SELECT * FROM gnd_flights WHERE id_flight='" . $row[16] . "'"));
                                                $arr_time = mysql_fetch_row(mysql_query("SELECT * FROM gnd_flighttime WHERE id_fltime='" . $row[15] . "'"));
                                                $dpt_flight_no = mysql_fetch_row(mysql_query("SELECT * FROM gnd_flights WHERE id_flight='" . $row[28] . "'"));
                                                $dpt_time = mysql_fetch_row(mysql_query("SELECT * FROM gnd_flighttime WHERE id_fltime='" . $row[27] . "'"));                                                     
                                                $tour_oper = mysql_fetch_row(mysql_query("SELECT * FROM gnd_touroperator WHERE id='" . $row[5] . "'"));
