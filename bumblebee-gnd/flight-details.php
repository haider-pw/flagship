...
$flight = mysql_fetch_row(mysql_query("SELECT * FROM gnd_flights WHERE id_flight='" . QuoteSmart($_GET['id']) . "'"));
$flight_id = $_GET['id'];

$flight_time = mysql_query("SELECT * FROM gnd_flighttime WHERE id_flight = $flight_id");
