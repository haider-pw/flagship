...
//determine if guest is Adult, Child, Infant and decrease count by 1
 ...
 $guest_check = mysql_fetch_row(mysql_query("SELECT * FROM fll_guest WHERE id='" . $guest_id . "'"));
...
$sql=mysql_query("delete from fll_guest where id='$guest_id'");
