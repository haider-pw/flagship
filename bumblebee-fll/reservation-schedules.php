...
//$reservations = mysql_query("SELECT * FROM fll_reservations WHERE status = 1 AND assigned = 1 AND yearweek(arr_date) = yearweek(curdate())");
//$reservations = mysql_query("SELECT * FROM fll_reservations WHERE status = 1 AND assigned = 1");

//Grab all reservation info
$reservationQuery = "SELECT * FROM fll_reservations WHERE status = 1 AND assigned = 1";
