...
site_header('Transport Report - ' . $reportdate);


//Grab all reservation info
$transport = mysql_query("SELECT * FROM fll_resdrivers WHERE transport_date = DATE_SUB(NOW(), INTERVAL 1 DAY) ORDER BY transport_date");
?>
...
<!--end table ordering --> 
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>Reports</li>                    
                    <li class="active"><a href="transport-report-day.php">Transport Report - Today</a></li>
                </ul>
                <!-- END BREADCRUMB -->
                ...
                <div class="page-content-wrap">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <select id="report_select" onChange="window.document.location.href=this.options[this.selectedIndex].value;" value="GO" class="form-control">
                                    ...
                                    <table id="transfer-queue" class="table table-hover datatable">
                                        ...
                                        <?php
                                            while($row = mysql_fetch_array($transport)) {
                                                ...
                                                $driver = mysql_fetch_row(mysql_query("SELECT * FROM fll_transport WHERE id_transport='" . $row[1] . "'"));
                                                $tour_oper = mysql_fetch_row(mysql_query("SELECT * FROM fll_touroperator WHERE id='" . $row[7] . "'"));
                                                $flight = mysql_fetch_row(mysql_query("SELECT * FROM fll_flights WHERE id_flight='" . $row[13] . "'"));
                                                $pickup = mysql_fetch_row(mysql_query("SELECT * FROM fll_flighttime WHERE id_fltime='" . $row[9] . "'"));
                                                $location = mysql_fetch_row(mysql_query("SELECT * FROM fll_location WHERE id_location='" . $row[8] . "'"));
                                                $guest = mysql_query("SELECT * FROM fll_guest WHERE ref_no_sys='" . $row[3] . "'");
