...
$reservationQueryResource = mysql_query("SELECT * FROM fll_reservations WHERE id='" . $_GET['id'] . "' AND (fast_track = 1 or ftnotify = 1)");
...
$operselect = mysql_query("SELECT * FROM fll_fsft_touroperator ORDER BY tour_operator ASC");
...
//    $room_no       = QuoteSmart($_POST['room_no']);  
    ...
    $sql_4 = "INSERT INTO fll_activity ". 
        ...
        if(! $retval )
            ...
            echo "<script>window.location='ftreservation-details.php?id=".$reservation[0]."&ok=1'</script>";
            mysql_close($conn);
	}
    ob_end_flush();
?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <h4>FSFT Reservation Details</h4>
                                </div>
                                <div class="panel-body">                                                                        
