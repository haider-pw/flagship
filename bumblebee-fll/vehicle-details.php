...
$vehicle = mysql_fetch_row(mysql_query("SELECT * FROM fll_vehicles WHERE id_vehicle='" . QuoteSmart($_GET['id']) . "'"));
$vehicle_id = $_GET['id'];
...
if(isset($_POST['update']))
{
    ...
    $sql_1 = "INSERT INTO fll_activity ". 
        ...
        echo "<script>window.location='transport-details.php?id=".$transport_id."&ok=3'</script>";
        mysql_close($conn);
	}
ob_end_flush();
?>
