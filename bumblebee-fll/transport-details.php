...
$transport = mysql_fetch_row(mysql_query("SELECT * FROM fll_transport WHERE id_transport='" . QuoteSmart($_GET['id']) . "'"));
$transport_id = $_GET['id'];

$vehicles = mysql_query("SELECT * FROM fll_vehicles WHERE id_transport = $transport_id");
