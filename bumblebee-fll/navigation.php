...
$ftrows = mysql_query("SELECT ftnotify FROM fll_reservations WHERE ftnotify = 1 AND status = 1");
if($ftrows){
...
?>
<li class="xn-title">Navigation - FLL <span class="flag-icon flag-icon-us"></span></li>
<li class="active">
...
=======
                        <li><a href="ground-handling-adhoc.php?sect=gh"><span class="fa fa-truck"></span> All Reports (ad hocs)</a></li>
>>>>>>> Stashed changes
                ...
                <li class="xn-openable"><!-- Reports dropdown -->
                    ...
                    <ul>
                        <li><a href="ground-handling-adhoc.php?sect=fsft"><span class="fa fa-truck"></span> All Reports (ad hocs)</a></li>
