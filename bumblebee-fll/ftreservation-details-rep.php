...
//$reservation = mysql_fetch_row(mysql_query("SELECT * FROM fll_reservations WHERE id='" . QuoteSmart($_GET['id']) . "' AND fast_track = 1"));
$reservation = mysql_fetch_array(mysql_query("SELECT * FROM fll_reservations WHERE id='" . QuoteSmart($_GET['id']) . "' AND fast_track = 1"));
/*echo '<pre>';
print_r($reservation);
exit;*/
$get_rep = mysql_fetch_row(mysql_query("SELECT * FROM fll_reps WHERE id_rep='" . $reservation[42] . "'"));
$repselect = mysql_query("SELECT * FROM fll_reps ORDER BY name ASC");
...
$queryRepTypes = "SELECT * FROM fll_rep_services WHERE section = 1 OR section = 2";
...
//Sanitize data
    ...
    $rep_action = mysql_fetch_row(mysql_query("SELECT * FROM fll_reps WHERE id_rep='" . $rep_name . "'"));
