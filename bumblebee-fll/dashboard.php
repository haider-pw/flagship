...
$res = mysql_query("SELECT * FROM fll_reservations WHERE arr_date >= DATE(NOW()) AND status = 1");
$res_count = mysql_num_rows($res);

$transport = mysql_query("SELECT * FROM fll_resdrivers WHERE transport_date >= DATE(NOW())");
                        ...
                        <div class="col-md-3">
                            <div class="widget widget-success widget-item-icon">
                                ...
                                <div class="widget-data">
                                    <div class="widget-int num-count"><?php echo ($res_count < 1) ? 'Zero' : ''; ?></div>
                                    <div class="widget-title">Active Reservation<?php echo ($res_count == 1) ? '' : 's'; ?></div>
                                    <div class="widget-subtitle"><a href="add-reservation.php"><i class="fa fa-plus-square"></i> Add New</a> | <a href="view-reservations-arr.php"><span class="fa fa-calendar"></span> View Reservations</a></div>
                                </div>                            
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="widget widget-success widget-item-icon">
                                ...
                                <div class="widget-data">
                                    <div class="widget-int num-count"><?php echo ($transport_count < 1) ? 'Zero' : ''; ?></div>
                                    <div class="widget-title">Active Transfer<?php echo ($transport_count == 1) ? '' : 's'; ?></div>
