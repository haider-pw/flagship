...
$reservation = mysql_fetch_row(mysql_query("SELECT * FROM fll_reservations WHERE id='" . $reservation_id . "'"));
$adult = $reservation[8];
$child = $reservation[9];
