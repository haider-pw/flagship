...
$rep = mysql_fetch_row(mysql_query("SELECT * FROM bgi_reps WHERE id_rep='" . QuoteSmart($_GET['id']) . "'"));
$rep_id = $_GET['id'];
...
if(isset($_POST['update']))
{
    ...
    $sql_1 = "INSERT INTO bgi_activity ". 
        ...
        if(! $retval )
            ...
            echo "<script>window.location='rep-details.php?id=".$rep_id."&ok=1'</script>";
        mysql_close($conn);
	}
ob_end_flush();
?>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">                                                                        
                                    <div class="form-group col-xs-7"><!-- Location name record field -->
                                        <label for="rep-namer">Rep Name</label>
...
$ok= isset($_GET['ok']);
if($ok)  {
    echo '<script> alert("Rep details successfully updated"); </script>';
    }
    ?>
    </body>
</html>