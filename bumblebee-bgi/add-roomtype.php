...
//Sanitize data
    ...
    $sql_1 = "INSERT INTO bgi_activity ". 
        ...
        if(!$retval )
            ...
            echo "<script>window.location='location-details.php?id=".$location_id."&ok=2'</script>";
        mysql_close($conn);
	}
ob_end_flush();
?>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">                                                                        
                                    <div class="form-group col-xs-7"><!-- Room name record field -->
                                        <input type="text" class="form-control text-capitalize" placeholder="Room Type" id="room-name" name="room_name" autofocus="true">
                                    </div>
