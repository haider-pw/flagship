                                ...
                                <h5>Guest Details</h5>
                                    <div class="form-group">                                         
                                        <div class="form-inline col-xs-12"><!-- guest first name / guest last name fields -->
                                            ...
                                            <label>Last name</label> <input type="text" class="form-control right20 text-capitalize" placeholder="Last name" id="guest-last-name2" name="guest_last_name2" value="">
                                ...
                                <h5>Guest Details</h5>
                                    ...
                                    <div class="form-group">                                         
                                        <div class="form-inline col-xs-8"><!-- guest first name / guest last name fields -->
                                            ...
                                            <input type="number" min=0 max=12 class="left20 form-control" id="infant_age3" name="infant_age3" value="" placeholder="Infant - 12 months or less"> Months
                                        </div>
                                    </div>
