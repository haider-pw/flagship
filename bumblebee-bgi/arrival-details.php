...
$get_arr_vehicle = mysql_fetch_row(mysql_query("SELECT * FROM skb_vehicles WHERE id_vehicle='" . $reservation[8] ."'"));
                                        ...
                                        if($section == 'gh'){ ?>
                                            <div class="form-group">
                                                <div class="form-inline col-xs-6 col-sm-12">
                                                    ...
                                                    <label class="right20">Excursion Date</label><input type="text" class="right20 form-control datepicker" id="excursion_date" name="excursion_date" placeholder="Excursion Date" value="<?=date('Y-m-d',strtotime($excursion_date))?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-inline col-xs-6 col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <div class="form-inline col-xs-6 col-sm-12">
                                                    <label class="right20">Date of Confirmation</label><input type="text" class="form-control datepicker" id="excursion_confirm_date" name="excursion_confirm_date" placeholder="Excursion Confirm Date" value="<?=date('Y-m-d',strtotime($excursion_confirm_date))?>">
